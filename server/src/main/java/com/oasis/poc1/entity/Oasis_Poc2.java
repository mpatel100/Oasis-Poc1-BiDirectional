...
public class Oasis_Poc2 {
	...
	public String toString() {
		return "Oasis_Poc2 [id=" + id + ", label_name=" + label_name + ", entity_name=" + entity_name + ", value="
				+ value + ", attribute_name=" + attribute_name + ", tooltip=" + tooltip + ", saved_timestamp="
				+ saved_timestamp + "]";
	}
